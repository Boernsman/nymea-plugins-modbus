...
//            qCDebug(dcHuawei()) << "Connection init" << kostalConnection;
...
//                qCDebug(dcHuawei()) << thing << "total AC power changed" << totalAcPower << "W";
...
//                qCDebug(dcHuawei()) << thing << "total energy consumed changed" << totalHomeConsumption << "Wh";
...
//                qCDebug(dcHuawei()) << thing << "current phase 1 changed" << currentPhase1 << "A";
...
//                qCDebug(dcHuawei()) << thing << "current phase 2 changed" << currentPhase2 << "A";
...
//                qCDebug(dcHuawei()) << thing << "current phase 3 changed" << currentPhase3 << "A";
...
//                qCDebug(dcHuawei()) << thing << "voltage phase 1 changed" << voltagePhase1 << "V";
...
//                qCDebug(dcHuawei()) << thing << "voltage phase 2 changed" << voltagePhase2 << "V";
...
//                qCDebug(dcHuawei()) << thing << "voltage phase 3 changed" << voltagePhase3 << "V";
...
//                qCDebug(dcHuawei()) << thing << "active power phase 1 changed" << activePowerPhase1 << "W";
...
//                qCDebug(dcHuawei()) << thing << "active power phase 2 changed" << activePowerPhase2 << "W";
...
//                qCDebug(dcHuawei()) << thing << "active power phase 3 changed" << activePowerPhase3 << "W";
...
//        if (!connectionThing) {
//            qCWarning(dcHuawei()) << "Failed to set up kostal energy meter because the parent thing with ID" << thing->parentId().toString() << "could not be found.";
...
//        if (!kostalConnection) {
//            qCWarning(dcHuawei()) << "Failed to set up kostal energy meter because the connection for" << connectionThing << "does not exist.";
//            info->finish(Thing::ThingErrorHardwareNotAvailable);
//            return;
//        }
...
//            qCDebug(dcHuawei()) << thing << "total active power changed" << powerMeterTotalActivePower << "W";
...
//            qCDebug(dcHuawei()) << thing << "current phase 1 changed" << powerMeterCurrentPhase1 << "A";
...
//            qCDebug(dcHuawei()) << thing << "current phase 2 changed" << powerMeterCurrentPhase2 << "A";
...
//            qCDebug(dcHuawei()) << thing << "current phase 3 changed" << powerMeterCurrentPhase3 << "A";
...
//            qCDebug(dcHuawei()) << thing << "voltage phase 1 changed" << powerMeterVoltagePhase1 << "V";
...
//            qCDebug(dcHuawei()) << thing << "voltage phase 2 changed" << powerMeterVoltagePhase2 << "V";
...
//            qCDebug(dcHuawei()) << thing << "voltage phase 3 changed" << powerMeterVoltagePhase3 << "V";
...
//            qCDebug(dcHuawei()) << thing << "power phase 1 changed" << powerMeterActivePowerPhase1 << "W";
...
//            qCDebug(dcHuawei()) << thing << "power phase 2 changed" << powerMeterActivePowerPhase2 << "W";
...
//            qCDebug(dcHuawei()) << thing << "power phase 3 changed" << powerMeterActivePowerPhase3 << "W";
...
//            qCDebug(dcHuawei()) << thing << "grid frequency changed" << gridFrequency << "Hz";
...
//        Thing *connectionThing = myThings().findById(thing->parentId());
//        if (!connectionThing) {
//            qCWarning(dcHuawei()) << "Failed to set up kostal battery because the parent thing with ID" << thing->parentId().toString() << "could not be found.";
//            info->finish(Thing::ThingErrorHardwareNotAvailable);
//            return;
//        }
...
//        KostalConnection *kostalConnection = m_kostalConnections.value(connectionThing);
//        if (!kostalConnection) {
//            qCWarning(dcHuawei()) << "Failed to set up kostal battery because the connection for" << connectionThing << "does not exist.";
//            info->finish(Thing::ThingErrorHardwareNotAvailable);
//            return;
//        }
...
//            qCDebug(dcHuawei()) << thing << "battery SoC changed" << batteryStateOfCharge << "%";
...
//            qCDebug(dcHuawei()) << thing << "battery charge current changed" << batteryActualPower << "W";
...
//            qCDebug(dcHuawei()) << thing << "battery work capacity changed" << batteryWorkCapacity << "Wh";
...
//                qCDebug(dcHuawei()) << "There is no battery connected to the inverter" << thing;
//                return;
//            }

//            qCDebug(dcHuawei()) << "There is a battery connected but not set up yet. Creating a battery" << kostalConnection->batteryType();
//            // No meter thing created for this inverter, lets create one with the inverter as parent
